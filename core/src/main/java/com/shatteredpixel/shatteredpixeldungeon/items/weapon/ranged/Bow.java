...
public class Bow extends Weapon {
    ...
    public String info() {
        ...
        info += "\n\n" + Messages.get( com.shatteredpixel.shatteredpixeldungeon.items.weapon.SpiritBow.class, "stats",
    ...
    public com.shatteredpixel.shatteredpixeldungeon.items.weapon.ranged.Bow.Arrow knockArrow(){
        return new com.shatteredpixel.shatteredpixeldungeon.items.weapon.ranged.Bow.Arrow();
    }
    ...
    public class Arrow extends MissileWeapon {
        ...
        @Override
        public int damageRoll(Char owner) {
            return com.shatteredpixel.shatteredpixeldungeon.items.weapon.ranged.Bow.this.damageRoll(owner);
        }

        @Override
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return com.shatteredpixel.shatteredpixeldungeon.items.weapon.ranged.Bow.this.hasEnchant(type, owner);
        }

        @Override
        public int proc(Char attacker, Char defender, int damage) {
            return com.shatteredpixel.shatteredpixeldungeon.items.weapon.ranged.Bow.this.proc(attacker, defender, damage);
        }

        @Override
        public float delayFactor(Char user) {
            return com.shatteredpixel.shatteredpixeldungeon.items.weapon.ranged.Bow.this.delayFactor(user);
        }

        @Override
        public float accuracyFactor(Char owner, Char target) {
            if (sniperSpecial && com.shatteredpixel.shatteredpixeldungeon.items.weapon.ranged.Bow.this.augment == Augment.DAMAGE){
        ...
        @Override
        public int wepTier() {
            return com.shatteredpixel.shatteredpixeldungeon.items.weapon.ranged.Bow.this.wepTier();
        }
        ...
        protected void onThrow( int cell ) {
            ...
            if (enemy == null || enemy == curUser) {
                ...
                if (sniperSpecial && com.shatteredpixel.shatteredpixeldungeon.items.weapon.ranged.Bow.this.augment != Augment.SPEED) sniperSpecial = false;
            }
        }
        ...
        public void cast(final Hero user, final int dst) {
            ...
            com.shatteredpixel.shatteredpixeldungeon.items.weapon.ranged.Bow.this.targetPos = cell;
            if (sniperSpecial && com.shatteredpixel.shatteredpixeldungeon.items.weapon.ranged.Bow.this.augment == Augment.SPEED){
                                    ...
                                    public void call() {
                                        ...
                                        if (flurryCount > 0){
                                            Actor.add(new Actor() {
                                                ...
                                                protected boolean act() {
                                                    flurryActor = this;
                                                    int target = QuickSlotButton.autoAim(enemy, com.shatteredpixel.shatteredpixeldungeon.items.weapon.ranged.Bow.Arrow.this);
    ...
    private CellSelector.Listener shooter = new CellSelector.Listener() {
        ...
        public String prompt() {
            return Messages.get(com.shatteredpixel.shatteredpixeldungeon.items.weapon.ranged.Bow.class, "prompt");
        }
    };
}